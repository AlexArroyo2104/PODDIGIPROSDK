...
public class Atributos_fecha: Atributos_Generales {
    ...
    public var fechamax: String = ""                       // Si aplica
    public var fechamin: String = ""                       // Si aplica
    public var formato: String = "d/m/Y"                   // Si Aplica
    ...
    public var separador: String = ""                      /// Si aplica
