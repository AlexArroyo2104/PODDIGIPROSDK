...
public typealias SwipeActionHandler = (SwipeActionEureka, BaseRow, ((Bool) -> Void)?) -> Void

public class SwipeActionEureka: ContextualAction {
...
public struct SwipeConfiguration {
	...
	public var actions: [SwipeActionEureka] = []
}
