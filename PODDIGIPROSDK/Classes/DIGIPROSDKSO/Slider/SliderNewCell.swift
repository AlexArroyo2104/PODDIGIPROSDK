...
public class SliderNewCell: Cell<String>, CellType, UITextViewDelegate {
    ...
    public var genericRow: SliderNewRow! {return row as? SliderNewRow}
    ...
    public func setObject(obj: Elemento){
        ...
        lblIntervalo.text = "Intervalo: \(atributos.intervalo)"
        ...
        setEdited(v: atributos?.valor ?? "0")

        sliderView.value = Float(atributos!.numerominimo)
        self.intervaloSlider = Float(atributos.intervalo)
       
        self.labelValor.text = "Valor: \(Float(atributos!.numerominimo))"
        sliderView.maximumValue = Float(atributos!.numeromaximo)
        self.labelMax.text = "\(Float(atributos!.numeromaximo))"
        sliderView.minimumValue = Float(atributos!.numerominimo)
        self.labelMin.text = "\(Float(atributos!.numerominimo))"
    ...
    open override func setup() {
        ...
        sliderView.addTarget(self, action: #selector(changeVlaue(_: _:)), for: .valueChanged)
    ...
    @objc func changeVlaue(_ sender: UISlider, _ event: UIEvent) {
        self.valueSlider = "\(Int(sender.value))"
        self.labelValor.text = "Valor: \(Int(sender.value))"
        ...
        if row.isValid{
            ...
            if row.value == nil{
                ...
                if row.isValid && row.value != nil {
                    ...
                    self.elemento.validacion.valor = self.valueSlider
                    self.elemento.validacion.valormetadato = self.valueSlider
                }else{
                    self.elemento.validacion.validado = false
                    self.elemento.validacion.valor = ""
                    self.elemento.validacion.valormetadato = ""
